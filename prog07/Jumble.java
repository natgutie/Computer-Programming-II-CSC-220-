...
public class Jumble {
  ...
  public static void main (String[] args) {
    ...
    while (in.hasNextLine()) {
      ...
      /// add key value pairs, what should be your key and what should be your value
      // put()
  ...
  // also test by
  //    modifying Jumble to remove, get, and put again for each word.  The
